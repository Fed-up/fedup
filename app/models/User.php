...
class User extends Eloquent implements UserInterface, RemindableInterface {
	 ...
	 * @var string
	 */
	 //This is where you can define what you called your users table
	...
	public function MenuRecipes(){ //One recipe has many recipe ingredients
		return $this->belongsToMany('MenuRecipes', 'paid', 'user_id', 'link_id')->withPivot('paid','type')->withTimestamps();
	}

	public function Events(){ //One recipe has many recipe ingredients
